...
class formatOutput {
    ...
    build(){
        for (var i = 0, elementCount = this.jsonCodeBlock.childCodeBlockElements.length; i < elementCount; i++) {
            ...
            var setStartColumn = 19;// Starting keyname column position
            ...
            if(setStartColumn > 25 && currentElement.key){
                setStartColumn += 8;
            }
            ...
            }//leftSpace + '"' + currentElement.key + '_' + setStartColumn + '": ';
            ...
            if(currentElement.codeBlockValue !== null && currentElement.codeBlockValue.childCodeBlockElements.length > 0){
                ...
                if(currentElement.blockType == 'Array'){
                    ...
                    if(isKeyname(currentElementProp,this.specialFormatKeys)){
                        if(currentElement.key){
                            ...
                            this.generateJSONString += ''.padEnd(newSpacecurrent);
                        }
                ...
                if(currentElement.blockType == 'Object'){
                    ...
                    if(!currentElement.key){
                        ...
                        var addSpace = '';
                        //Colon position
                        var parentkeyLangth = currentElement.codeBlockValue.parentCodeBlock.parentCodeBlock.keyLength;// Parent keyname length
                        ...
                        this.generateJSONString += ''.padEnd((setStartColumn-12)); // Align to open brackets
                        //this.generateJSONString += closeBracketLeft; // Add tabs before closing bracket 
                    }
