...
class JSONConstructor {
    ...
    constructor(){
        this.codeBlock = null;
        this.codeBlockElement = null;
    }
    //JSON Parser function
    buildIterator(useCodeBlock,object) {
        for (var property in object) {
            if (object.hasOwnProperty(property)) {
                var newCodeBlockElement = this.createCodeBlock(useCodeBlock,object,property);
    ...
    createCodeBlockElement(useCodeBlock,currentCodeBlockElement){
        ...
        return newCodeBlockElement;
    }
    createCodeBlock(useCodeBlock,obj,prop){
        ...
        currentCodeBlockElement.keyLength = prop.length;
        ...
        if((blockType = regex.exec(objectType)) !== null){
            currentCodeBlockElement.blockType = blockType[1];// String, Array, or Object
        }
        ...
        if(objectType === '[object Object]' || objectType === '[object Array]'){
            ...
            var newCodeBlockElement = this.createCodeBlockElement(useCodeBlock,currentCodeBlockElement);
        ...
        return newCodeBlockElement || null;
    }
}
...
function formatJSON(jsonCodeBlock) {   
    ...
    for (var i = 0, elementCount = jsonCodeBlock.childCodeBlockElements.length; i < elementCount; i++) {
        ...
        var largestKeyname = Math.max.apply(null,highestLevel);// Find the largest value/Level
        ...
        }else if(currentElement.blockType == 'Array'){
        ...
        if(currentElement.codeBlockValue !== null && currentElement.codeBlockValue.childCodeBlockElements.length > 0){
            ...
            if(currentElement.blockType == 'Object'){
                ...
                generateJSONString += spaceIndent + addSpace; // Add indentation
...
function str(jsonText) {
    ...
    try {
        ...
        var builtObject = new JSONConstructor();
